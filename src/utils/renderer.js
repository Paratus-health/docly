...
async function startCapture(screenshotIntervalSeconds = 5, imageQuality = 'medium') {
    ...
    console.log('Capture disabled - no screen or audio permissions required');
    
    // App now operates in text-only mode without any capture functionality
    cheddar.setStatus('ready');
}
...
async function captureScreenshot(imageQuality = 'medium', isManual = false) {
    console.log('Screenshot capture disabled - no permissions required');
    return;
}

async function captureManualScreenshot(imageQuality = null) {
    console.log('Manual screenshot disabled - no permissions required');
    return;
}
